...
{};for(var m=$jscomp.makeIterator(a[g]),h=m.next();!h.done;h=m.next())h=h.value,f.$jscomp$loop$prop$fc$27[h]=b[h];m=Object.keys(f.$jscomp$loop$prop$fc$27);m.sort(function(a){return function(b,d){return a.$jscomp$loop$prop$fc$27[d]===a.$jscomp$loop$prop$fc$27[b]?c.compareNames(b,d):a.$jscomp$loop$prop$fc$27[d]-a.$jscomp$loop$prop$fc$27[b]}}(f));m=$jscomp.makeIterator(m);for(h=m.next();!h.done;h=m.next()){h=h.value;var k=encodeURI(this.homepages[h]),n=this.dblpAuthors[h];l+='<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><small><a title="Click for author\'s home page." target="_blank" href="'+
k+'" onclick="trackOutboundLink(\''+k+"', true); return false;\">"+h+"</a>&nbsp;";this.acmfellow.hasOwnProperty(h)&&(l+='<span title="ACM Fellow"><img alt="ACM Fellow" src="'+this.acmfellowImage+'"></span>&nbsp;');this.turing.hasOwnProperty(h)&&(l+='<span title="Turing Award"><img alt="Turing Award" src="'+this.turingImage+'"></span>&nbsp;');l+='<font style="font-variant:small-caps" size="-1">'+this.areaString(h).toLowerCase()+"</em></font>&nbsp;";l+='<a title="Click for author\'s home page." target="_blank" href="'+
...
n+"', true); return false;\">"+f.$jscomp$loop$prop$fc$27[h]+'</a></small></td><td align="right"><small>'+(Math.round(10*d[h])/10).toFixed(1)+'</small></td></tr><tr><td colspan="4"><div style="display:none;" id="'+escape(h)+'-chart"></div></td></tr>'}l+="</tbody></table></div>";e[g]=l}f={$jscomp$loop$prop$fc$27:f.$jscomp$loop$prop$fc$27}}return e};
...
CSRankings.prototype.updatedURL=function(){for(var a="",b=0,d=0,c={},e=0;e<this.fields.length;c={$jscomp$loop$prop$allChecked$29:c.$jscomp$loop$prop$allChecked$29},e++){var f="input[name="+this.fields[e]+"]";this.fields[e]in CSRankings.parentMap||(d+=1);!$(f).prop("checked")||this.fields[e]in CSRankings.parentMap||(c.$jscomp$loop$prop$allChecked$29=1,this.fields[e]in CSRankings.childMap&&CSRankings.childMap[this.fields[e]].forEach(function(a){return function(b){var c=$("input[name="+b+"]").prop("checked");
a.$jscomp$loop$prop$allChecked$29=b in CSRankings.nextTier?a.$jscomp$loop$prop$allChecked$29&(c?0:1):a.$jscomp$loop$prop$allChecked$29&c}}(c)),c.$jscomp$loop$prop$allChecked$29&&(a+=this.fields[e]+"&",b+=1))}0<b&&(a=a.slice(0,-1));c=$("#regions").find(":selected").val();e="";f=(new Date).getFullYear();var g=parseInt($("#fromyear").find(":selected").text()),l=parseInt($("#toyear").find(":selected").text());if(g!=f-10||l!=f)e+="/fromyear/"+g.toString(),e+="/toyear/"+l.toString();e=b==d?e+"/index?all":
...
b={};for(d=0;d<this.fields.length;b={$jscomp$loop$prop$field$33:b.$jscomp$loop$prop$field$33,$jscomp$loop$prop$str$34:b.$jscomp$loop$prop$str$34},d++)b.$jscomp$loop$prop$str$34="input[name="+this.fields[d]+"]",b.$jscomp$loop$prop$field$33=this.fields[d],$(b.$jscomp$loop$prop$str$34).click(function(b){return function(){var c=!0;if(b.$jscomp$loop$prop$field$33 in CSRankings.parentMap){c=!1;var d=CSRankings.parentMap[b.$jscomp$loop$prop$field$33],e="input[name="+d+"]",f=0,k=1;CSRankings.childMap[d].forEach(function(a){var b=
$("input[name="+a+"]").prop("checked");f|=b;k=a in CSRankings.nextTier?k&(b?0:1):k&b});$(e).prop("checked",f);f&&!k||$(e).prop("disabled",!1);f&&!k&&$(e).prop("disabled",!0)}else if(d=$(b.$jscomp$loop$prop$str$34).prop("checked"),b.$jscomp$loop$prop$field$33 in CSRankings.childMap){e=$jscomp.makeIterator(CSRankings.childMap[b.$jscomp$loop$prop$field$33]);for(var n=e.next();!n.done;n=e.next()){n=n.value;var p="input[name="+n+"]";n in CSRankings.nextTier?$(p).prop("checked",!1):$(p).prop("checked",
d)}}a.rank(c)}}(b));var c={all_areas_on:function(){a.activateAll()},all_areas_off:function(){a.activateNone()},ai_areas_on:function(){a.activateAI()},ai_areas_off:function(){a.deactivateAI()},systems_areas_on:function(){a.activateSystems()},systems_areas_off:function(){a.deactivateSystems()},theory_areas_on:function(){a.activateTheory()},theory_areas_off:function(){a.deactivateTheory()},other_areas_on:function(){a.activateOthers()},other_areas_off:function(){a.deactivateOthers()}};b={};for(var e in c)b.$jscomp$loop$prop$item$36=
e,document.getElementById(b.$jscomp$loop$prop$item$36).addEventListener("click",function(a){return function(){c[a.$jscomp$loop$prop$item$36]()}}(b)),b={$jscomp$loop$prop$item$36:b.$jscomp$loop$prop$item$36}};CSRankings.minToRank=30;CSRankings.areas=[];CSRankings.topLevelAreas={};CSRankings.topTierAreas={};CSRankings.regions="USA europe canada northamerica southamerica australasia asia africa world".split(" ");CSRankings.parentIndex={};
